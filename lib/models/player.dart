...
class Player {
  ...
  static List<List<String>> matrix =
      List.generate(3, (i) => List.filled(3, ''));
  static List<List<Color>> cardColors =
      List.generate(3, (i) => List.filled(3, kContainerCardColor));
  ...
  static String getAlertTitle() {
    if (winner)
      return p1 == side
          ? '${Settings.playerNames[0]} Wins!'
          : '${Settings.playerNames[1]} Wins!';
    return 'Its a tie!';
  }
  ...
  static String getResultText() {
    if (winner)
      return p1 == side
          ? '${Settings.playerNames[0]} Won'
          : '${Settings.playerNames[1]} Won';
    return 'Draw!';
  }
